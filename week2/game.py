...
ENEMY_SPEED = 4 # 敌机速度
ENEMY_IMG1 = "./images/e0.png"   # 敌机图片1d
ENEMY_IMG2 = "./images/e1.png"   # 敌机图片2
ENEMY_IMG3 = "./images/e2.png"   # 敌机图片3
...
class Bullet(Game):
    ...
    # 显示英雄子弹
    def display(self):
        self.screen_plane.blit(self.image,(self.x-24 ,self.y)) # 填充画布
        ...
        for en in enemy_lis:
            ...
            for i in en.bullets:
                ...
                if i.y > 600:  # 已经出界的子弹，销毁对象
                    en.bullets.remove(i)
                crs = Crash(i, hero, screen_main)  # 传入检测对象
